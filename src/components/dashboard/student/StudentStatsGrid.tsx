...
export default function StudentStatsGrid({
  ...
  return (
    <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
      <div className="rounded-2xl border bg-card p-4 sm:p-5 bg-white dark:bg-gray-800">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            <p className="text-sm text-muted-foreground">Enrolled</p>
            <p className="mt-1 text-2xl font-bold text-foreground">{totalCourses}</p>
          </div>
          <div className="rounded-xl bg-muted p-2 bg-violet-600 dark:bg-indigo-500">
      ...
      <div className="rounded-2xl border bg-card p-4 sm:p-5 bg-white dark:bg-gray-800">
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="rounded-xl bg-muted p-2 bg-violet-600 dark:bg-indigo-500">
            <BookmarkCheck className="h-5 w-5 text-foreground/80" />
          </div>
        </div>
      </div>
      ...
      <div className="rounded-2xl border bg-card p-4 sm:p-5 bg-white dark:bg-gray-800">
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="rounded-xl bg-muted p-2 bg-violet-600 dark:bg-indigo-500">
            <CalendarClock className="h-5 w-5 text-foreground/80" />
          </div>
        </div>
      </div>
    </div>
