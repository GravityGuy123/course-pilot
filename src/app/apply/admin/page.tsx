      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-base sm:text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            {`Help us manage and grow the platform. Share your experience and let's build something amazing together`}
            .
          </p>
        </div>
          ...
          <CardContent className="p-6 sm:p-8 lg:p-10 space-y-8">
            ...
            <div className="bg-violet-50 dark:bg-violet-900/20 border border-violet-200 dark:border-violet-800 rounded-xl p-4 flex gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-violet-800 dark:text-violet-200 leading-relaxed">
                  Administrators manage the platform, moderate content, assist
                  users, and ensure everything runs smoothly. Share your
                  relevant experience and skills below.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <textarea
                  placeholder="Tell us about your professional background, admin experience, relevant skills, and why you'd be a great fit for this role..."
                  value={bio}
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">
                Provide details about your experience managing platforms, teams,
                or communities.
              </p>
            </div>
            ...
            <Button
              ...
              onClick={submit}
              disabled={!bio.trim() || !emailVerified} // enforced email verification
            >
              <svg
                className="w-5 h-5"
                fill="none"
